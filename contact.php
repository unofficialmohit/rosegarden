...
<td align="center" width="10%" bgcolor="skyblue"><a href="contact.php">Contact</a></td>
<td align="center" width="10%"><a href="feedback.php">Feedback</a></td>
<td align="center" width="10%"><a href="login.php">Login</a></td>
</tr>
<tr>
<td colspan="6"  class="head" id=borderimg>

<legend>	<h1> CONTACT US </h1><br><BR><BR></legend>

<fieldset style="border-width:10px;border-radius: 50px 20px;" >
<br><br>
Phone = 9998887776,9988776655 <br>
Type =	Park and tourist spot<br>
Location = Sector 16, Chandigarh<br>
Area = 	30 Acres<br>
Opened = 1967<br>
Founder	Mohinder Singh Randhawa the then UT Administrator<br>
Owned by Chandigarh Administration<br>
