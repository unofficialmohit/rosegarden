...
$result=mysqli_query($con,"select username,pass from login");
$user=$_COOKIE['username'];
while($row=mysqli_fetch_array($result))
{
if($_COOKIE['username']==$row['username'])
{
if($_COOKIE['password']==$row['pass'])
{
echo "
<tr><tr><td width='100%' colspan='6'>
