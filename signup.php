...
<td align="center" width="10%" bgcolor="orange"><a href="login.php">Login</a></td>
</tr>
<tr>
<td colspan="6" ><h2></h2>
    <center><br><Br>
    <form class="xyz" action="ssucess.php" method="POST" style="background: #b3ffb3">
<fieldset align=center>
<legend align=center><h1>SIGNUP</h1></legend>
Username&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp: <input type="text" name="username" class="input11" required><br><br>
Phone&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp: <input type="text" name="phone" class="input11" required><br><br>
Email&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp: <input type="text" name="email" class="input11" required><br><br>
State&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp: <input type="text" name="state" class="input11" required><br><br>
...
Password &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:<input type="Password" name="password" class="input11" required><br><br>
