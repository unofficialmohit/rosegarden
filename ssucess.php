...
$sql="INSERT INTO login VALUES('$user','$pass','$phone','$email','$state','$gender')";
if(mysqli_query($con, $sql)) {
	echo ("<script LANGUAGE='JavaScript'>
		window.alert('User : $user Successfull Signed Up.');
		window.location.href='login.php';
		</script>");
	}
	else {
		echo "ERROR";
		echo"$user<br>$pass<br>$phone<br>$email<br>$state<br>$gender";
	}
?>
</td>
</tr>
